...
-- every native Wayland client (kitty, the Quickshell shell process —
-- which now carries the bar, the notification surfaces, the OSD, the
-- power menu, the dashboard and (quick task 260822-sht) the app launcher
-- in one process — and Thunar-under-Wayland), pointed at `rose-pine-hyprcursor`
