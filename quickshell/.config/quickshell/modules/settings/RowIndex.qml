...
Singleton {
    ...
    readonly property list<var> rows: [
        ...
        { pageIdx: 8, section: "Animation", label: "Animation style", keywords: "animation style motion preset shell md3 snappy bouncy gravity precise zen caelestia" },
...
//    15). ─────────────────────────────────────────────────────────
        ...
        { pageIdx: 16, section: "Windows VM", label: "Status", keywords: "virtualization vm windows qemu kvm libvirt state running shut off domain" },
        ...
        { pageIdx: 16, section: "Linked drives", label: "What the Windows drive toggle does", keywords: "virtualization windows drive c: main recovery boot disk bare metal toggle real install qcow2 switch mode whole disk" },
        { pageIdx: 16, section: "Linked drives", label: "Before switching it on", keywords: "virtualization hibernation powercfg fast startup bitlocker device encryption tpm recovery key windows drive" },
        ...
        { pageIdx: 17, section: "System", label: "Shell version", keywords: "about system shell version bash fish" },
