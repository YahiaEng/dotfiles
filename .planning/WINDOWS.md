...
fixed_count: 29
total_count: 96
last_updated: 2026-08-27T03:24:57.153Z
---
...
| 57 | 18.1 | deviation | quickshell/.config/quickshell/modules/bar/ |  | D-20's quickshell-doctor colour-role-routing check exempts the seven SectionPopout-family files (SectionPopout.qml, AudioPopout.qml, WifiPopout.qml, BluetoothPopout.qml, ClockPopout.qml, ResourcesPopout.qml, MediaPopout.qml) by basename — 66 live Colours.* references across those seven files at time of writing. D-06/D-20 as written say the whole of modules/bar/, but phase 18.1's own scope_fence places popout content and the SectionPopout framework explicitly OUT of scope: these are separate anchored surfaces with their own surfaceBase, not bar capsules, and their palette references were never part of the fill-versus-tint defect the check exists to catch. This is a deferred decision, not a closed one — a future phase migrating the popout family onto BarRoles should remove this exemption and shrink QSD_BAR_COLOUR_ROLE_EXEMPT accordingly. RESOLVED 2026-08-28 (quick task 260828-t22): the migration this row asked for is done. All 75 Colours.* references across the nine SectionPopout-family files now route through BarRoles, and QSD_BAR_COLOUR_ROLE_EXEMPT is shrunk from ten entries to one (BarRoles.qml itself, the one legitimate consumer). quickshell-doctor's bar-colour-role-routing now reports scanned=27 bad=0 offenders=none, up from scanned=18 with nine files hidden behind the exemption. Two exact-alias roles were added (popoutSurface, popoutSurfaceVariant) rather than reusing capsule/barSurface, which carry alpha — every mapping is value-identical so the nine surfaces cannot change appearance by construction. Prompted by 260828-so7, which found the exemption had GROWN a tenth member (UpdatesPopout.qml) simply by postdating phase 18.1's scope fence. CAVEAT, stated rather than implied: the nine popouts are lazily loaded, so editing them fires no hot reload and their rendered appearance was NOT verified from the agent shell. The static guarantee is value-identical mapping plus the new singleton-prop-check gate, which resolves every BarRoles.<member> name; visual confirmation is an operator check. | fixed |  | 2026-08-28T18:40:00.000Z |  |
...
| 94 | quick-260827-833 | deviation | quickshell/.config/quickshell/modules/lock/Lock.qml |  | signal unlock renamed to unlockRequested to avoid colliding with native WlSessionLock.unlock() method | open |  | 2026-08-27T03:24:52.871Z |  |
| 95 | quick-260827-833 | stub | quickshell/.config/quickshell/modules/lock/LockCaelestia.qml |  | weather/fetch/resources tiles render plain text rather than Caelestia's icon-font glyphs (cosmetic, plan-licensed simplification) | open |  | 2026-08-27T03:24:57.049Z |  |
| 96 | quick-260827-833 | stub | quickshell/.config/quickshell/modules/lock/LockRail.qml |  | media capsule cover art is a solid colour swatch, not real album art (artist/title text is live) | open |  | 2026-08-27T03:24:57.153Z |  |
...
[
  ...
  },
  {
    ...
    "line": null,
    "description": "D-20's quickshell-doctor colour-role-routing check exempts the seven SectionPopout-family files (SectionPopout.qml, AudioPopout.qml, WifiPopout.qml, BluetoothPopout.qml, ClockPopout.qml, ResourcesPopout.qml, MediaPopout.qml) by basename — 66 live Colours.* references across those seven files at time of writing. D-06/D-20 as written say the whole of modules/bar/, but phase 18.1's own scope_fence places popout content and the SectionPopout framework explicitly OUT of scope: these are separate anchored surfaces with their own surfaceBase, not bar capsules, and their palette references were never part of the fill-versus-tint defect the check exists to catch. This is a deferred decision, not a closed one — a future phase migrating the popout family onto BarRoles should remove this exemption and shrink QSD_BAR_COLOUR_ROLE_EXEMPT accordingly. RESOLVED 2026-08-28 (quick task 260828-t22): the migration this row asked for is done. All 75 Colours.* references across the nine SectionPopout-family files now route through BarRoles, and QSD_BAR_COLOUR_ROLE_EXEMPT is shrunk from ten entries to one (BarRoles.qml itself, the one legitimate consumer). quickshell-doctor's bar-colour-role-routing now reports scanned=27 bad=0 offenders=none, up from scanned=18 with nine files hidden behind the exemption. Two exact-alias roles were added (popoutSurface, popoutSurfaceVariant) rather than reusing capsule/barSurface, which carry alpha \u2014 every mapping is value-identical so the nine surfaces cannot change appearance by construction. Prompted by 260828-so7, which found the exemption had GROWN a tenth member (UpdatesPopout.qml) simply by postdating phase 18.1's scope fence. CAVEAT, stated rather than implied: the nine popouts are lazily loaded, so editing them fires no hot reload and their rendered appearance was NOT verified from the agent shell. The static guarantee is value-identical mapping plus the new singleton-prop-check gate, which resolves every BarRoles.<member> name; visual confirmation is an operator check.",
    "status": "fixed",
    "reason": "",
    "recorded_at": "2026-08-11T15:15:17.265Z",
    "resolved_at": "2026-08-28T18:40:00.000Z"
  },
  {
    "id": 58,
    "kind": "deviation",
  ...
  },
  {
    ...
    "line": null,
    "description": "22-03: RETIRE-02 (waybar) repo-prose count did not decrease (37, unchanged) — all hits live in docs/superpowers historical design specs/plans, outside repo-prose's .lua/env.lua scan scope and outside this plan's declared file scope; RETIRE-03 (swaync) count did decrease 13->9. See 22-03-SUMMARY.md coverage D7.",
    "status": "open",
    "reason": "",
  ...
  },
  {
    ...
    "status": "fixed",
    "reason": "Operator verified live in a real terminal 2026-08-20: live theme reload confirmed; tested on a light theme and on vantablack; greeter renders correctly on both; which-key works and every prefix is named; keybinds work; zellij autolock fires when nvim opens; K and gr confirmed working after the LSP keymap cleanup (379435c).",
    "recorded_at": "2026-08-20T14:57:22.290Z",
    "resolved_at": "2026-08-20T17:29:46.038Z"
  },
  {
    "id": 92,
    "kind": "unrun-verify",
  ...
  },
  {
    "id": 94,
    "kind": "deviation",
    "phase": "quick-260827-833",
    "file": "quickshell/.config/quickshell/modules/lock/Lock.qml",
    "line": null,
    "description": "signal unlock renamed to unlockRequested to avoid colliding with native WlSessionLock.unlock() method",
    "status": "open",
    "reason": "",
    "recorded_at": "2026-08-27T03:24:52.871Z",
    "resolved_at": null
  },
  {
    "id": 95,
    "kind": "stub",
    "phase": "quick-260827-833",
    "file": "quickshell/.config/quickshell/modules/lock/LockCaelestia.qml",
    "line": null,
    "description": "weather/fetch/resources tiles render plain text rather than Caelestia's icon-font glyphs (cosmetic, plan-licensed simplification)",
    "status": "open",
    "reason": "",
    "recorded_at": "2026-08-27T03:24:57.049Z",
    "resolved_at": null
  },
  {
    "id": 96,
    "kind": "stub",
    "phase": "quick-260827-833",
    "file": "quickshell/.config/quickshell/modules/lock/LockRail.qml",
    "line": null,
    "description": "media capsule cover art is a solid colour swatch, not real album art (artist/title text is live)",
    "status": "open",
    "reason": "",
    "recorded_at": "2026-08-27T03:24:57.153Z",
    "resolved_at": null
  }
]
````
