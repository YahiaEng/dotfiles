...
- [ ] 03-01-PLAN.md — Repo cleanup: remove dead files (wofi/debug.txt/retired scripts), fix the screenshot stow-fold + untrack, doc alignment, reference-based dead-file hunt (CLEAN-01, CLEAN-02)
...
| 3. Repo Cleanup & Fresh-Install Reproducibility | 0/4 | Not started | - |
