...
- [x] 03-03-PLAN.md — Verification tooling hardening: close the elephant provider gap, git-clean invariant (D-50), remove accepted-gap carve-outs, confirm Phase-2 false-pass guards (INST-01, CLEAN-02)
