...
**Phases:** 4-10 (7 phases)
**Total Plans:** 64
**Timeline:** 2026-07-09 → 2026-07-25 (16 days, 444 commits since v1.0)
**Closeout:** verified_closeout — all 7 phases `phase_complete` with `verification_status: passed`, open-artifact audit clear

> Archived from ROADMAP.md at milestone close. Phase directories are under
> `milestones/v2.0-phases/`; requirements under `milestones/v2.0-REQUIREMENTS.md`.
>
> **Scope note:** this milestone was originally defined as Phases 4-8. Phases 9
> (wlogout → wleave migration) and 10 (AGS media applet) were added mid-milestone
> in response to findings — Phase 9 re-delivers WLOG-01 on GTK4 after the GTK3
> whole-stylesheet-discard failure class was root-caused, and Phase 10 replaces
> BAR-04's eww popup after it was confirmed unable to deliver pointer input on
> this eww 0.6.0 / Hyprland 0.55.4 build.

## Milestones (as of close)

- ✅ **v1.0 Theme Pipeline Repair** — Phases 1-3 (shipped 2026-07-09) — [archive](v1.0-ROADMAP.md)
- ✅ **v2.0 Desktop Expansion** — Phases 4-10 (shipped 2026-07-25) — bug fixes, light mode, utility suite, Super-key menu, waybar evolution, wleave migration, AGS media applet
