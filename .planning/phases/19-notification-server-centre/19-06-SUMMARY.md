...
**Commits, round 5:** `0e6a9e8` (feat(19-04), popup picture+badge), `cf062ed` (feat(19-06), centre picture+badge + item 1 x-button structural fix + item 3 widened critical detection). Item 2 needed no committed code change — diagnosis only, probes left uncommitted for the coordinator's human click-test alongside item 1's own probes.
